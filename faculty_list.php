...
$sql = "SELECT id, name, email, department, photo FROM faculty WHERE 1=1";
if (!empty($search)) {
...
$deptResult = $conn->query("SELECT DISTINCT department FROM faculty");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        img.profile-thumb { width:50px; height:50px; border-radius:50%; border:2px solid #40008a; }
    ...
    <table>
        ...
        <?php if($result->num_rows>0){ while($row=$result->fetch_assoc()){ ?>
            <tr>
                ...
                <td>
                    <a class="edit-link" href="edit_faculty.php?id=<?php echo $row['id']; ?>">Edit</a> | 
                    <a class="delete-link" href="faculty_list.php?delete_id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this faculty?');">Delete</a>
                </td>
            </tr>
        <?php }} else { echo "<tr><td colspan='6'>No faculty found</td></tr>"; } ?>
    </table>
</body>
</html>
